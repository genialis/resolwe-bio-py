...
class Relation(BaseResolweResource):
    ...
    descriptor = BaseField(access_type=FieldAccessType.WRITABLE)
    descriptor_schema = DictResourceField(
        resource_class_name="DescriptorSchema", access_type=FieldAccessType.WRITABLE
    )
    partitions = BaseField(access_type=FieldAccessType.WRITABLE)
    ...
    samples = DictResourceField(
        ...
        initial_loader=lambda relation: relation._lazy_load_samples(),
    )
