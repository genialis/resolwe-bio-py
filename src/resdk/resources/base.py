...
class BaseResource:
    ...
    def __init__(self, resolwe, initial_data_source=None, **model_data):
        ...
        # When testing make server default data source.
        testing = "PYTEST_VERSION" in os.environ
        if testing:
            initial_data_source = initial_data_source or DataSource.SERVER
